...
const BEAM_RERANK_TOP_K: usize = 3;
const BEAM_RERANK_FACTOR: f64 = 0.005;
    ...
    for r in 0..n {
        for c in 0..n {
            ...
            *rng = rng.wrapping_mul(6364136223846793005).wrapping_add(1442695040888963407);
            ...
            let density_fallback = if score < 1e-10 { density_scale * 2e-2 } else { 0.0 };
            let score = score + density_fallback;
