...
ENV PATH = /usr/local / cargo / bin: & #36;{PATH}
...
marathon - local - runner / bin / bash
```
...
For each executed test, the generic runner records member-visible results with 1-based testcase ordinals rather than configured seed values:
